...
impl Private<'_> {
    ...
    pub fn get_registration(&self) -> Result<RegistrationResponse> {
        let response = self
            .request("registration", Method::GET, Vec::new(), json!({}));
        response
    }

    pub fn get_user(&self) -> Result<UserResponse> {
        let response = self
            .request("users", Method::GET, Vec::new(), json!({}));
        response
    }

    pub fn get_api_keys(&self) -> Result<ApiKeysResponse> {
        let response = self
            .request("api-keys", Method::GET, Vec::new(), json!({}));
        response
    }

    pub fn get_account(&self, ethereum_address: &str) -> Result<AccountResponse> {
    ...
    pub fn get_accounts(&self) -> Result<AccountsResponse> {
        let response = self
            .request("accounts", Method::GET, Vec::new(), json!({}));
        response
    }

    pub fn update_user(&self, data: UserParams<'_>) -> Result<UserResponse> {
        let response = self.request("users", Method::PUT, Vec::new(), data);
        response
    }
    ...
    pub fn get_account_leaderboard_pnl(
        &self,
        period: &str,
    ...
    pub fn get_historical_leaderboard_pnls(
        &self,
        period: &str,
        limit: Option<&str>,
    ...
    pub fn create_order(&self, user_params: ApiOrderParams<'_>) -> Result<OrderResponse> {
        ...
        let naive = NaiveDateTime::from_timestamp_opt(user_params.expiration, 0).unwrap();
    ...
    pub fn cancel_order(&self, order_id: &str) -> Result<CancelOrderResponse> {
    ...
    pub fn cancel_all_orders(&self, market: Option<&str>) -> Result<CancelOrdersResponse> {
        let mut parameters = Vec::new();
        if let Some(local_var) = market {
            parameters.push(("market", local_var));
        }
    ...
    pub fn get_order_by_id(&self, id: &str) -> Result<OrderResponse> {
    ...
    pub fn get_order_by_client_id(&self, id: &str) -> Result<OrderResponse> {
    ...
    pub fn get_trading_rewards(&self, epoch: Option<&str>) -> Result<TradingRewardsResponse> {
        let mut parameters = Vec::new();
    ...
    pub fn get_liquidity_provider_rewards(
        &self,
        epoch: Option<&str>,
    ...
    pub fn get_retroactive_mining_rewards(&self) -> Result<RetroactiveMiningRewardsResponse> {
        let response = self
            .request(
    ...
    pub fn send_verification_email(&self) -> Result<StatusCode> {
        let response = self.put("emails/send-verification-email");
        response
    }

    pub fn request_testnet_tokens(&self) -> Result<TransferResponse> {
        let response = self
            .request("testnet/tokens", Method::POST, Vec::new(), json!({}));
        response
    }

    pub fn get_profile(&self) -> Result<ProfilePrivateResponse> {
        let response = self
            .request("profile/private", Method::GET, Vec::new(), json!({}));
        response
    }

 fn put(&self, path: &str) -> Result<StatusCode> {
 ...
 fn request<T: for<'de> Deserialize<'de>, V: Serialize>(
        &self,
        path: &str,
        method: Method,
